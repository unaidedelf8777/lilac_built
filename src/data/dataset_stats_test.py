...
class StatsSuite:
  ...
  def test_simple_stats(self, make_test_data: TestDataMaker) -> None:
  ...
  def test_nested_stats(self, make_test_data: TestDataMaker) -> None:
  ...
  def test_stats_approximation(self, make_test_data: TestDataMaker, mocker: MockerFixture) -> None:
    sample_size = 5
  ...
  def test_error_handling(self, make_test_data: TestDataMaker) -> None:
    dataset = make_test_data(SIMPLE_ITEMS)

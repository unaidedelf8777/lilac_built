...
v1_router.include_router(router_concept.router, prefix='/concepts', tags=['concept'])
v1_router.include_router(data_loader.router, prefix='/data_loaders', tags=['data_loader'])
